...
public class SlidingMenuModel {
    ...
    //TODO add real navigation items
   /* public enum NAV_NAMES {
    ...
    public void prepareData() {
        ...
        TypedArray selectedIcons = mContext.getResources().obtainTypedArray(R.array.nav_drawer_icons_selected);
        ...
        for (int i = 0; i < labels.length; i++) {
            menuList.add(new SlidingMenuItemModel(icons.getResourceId(i, -1), selectedIcons.getResourceId(i, -1), labels[i], startsActivity[i]));
        }
    }
