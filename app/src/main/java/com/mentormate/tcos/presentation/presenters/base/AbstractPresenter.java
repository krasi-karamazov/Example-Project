...
/**
 * Base class for all presenters that are interacting with all (hehe) interactors. This base class contains references to the Executor and MainThread objects that are needed for running interactor tasks on a background thread
 */
